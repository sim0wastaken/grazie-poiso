    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 to-slate-800 overflow-x-hidden">
      ...
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden px-4">
        ...
        <motion.div
          ...
          className="relative container mx-auto px-4 text-center mt-16 md:mt-0"
        >
      ...
      <div className="container mx-auto px-4 py-8 md:py-16 -mt-16 md:-mt-24 relative z-10">
      ...
      <section className="py-16 bg-slate-900/50">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-8">Perform the Ritual</h2>
          <p className="text-slate-300 mb-8 max-w-xl mx-auto">
            Channel your devotion to receive Poiso's blessing before your next match.
          </p>
          <Ritual />
        </div>
      </section>
